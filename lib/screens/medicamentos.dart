...
class MedicamentosPage extends StatefulWidget {
  ...
  const MedicamentosPage({Key? key, required this.idosoId, required this.apelido}) : super(key: key);
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => RegisterMedicamentosPage(idosoId: widget.idosoId),
                      ),
                    );
                  },
                ),
                        ...
                        return Card(
                          child: ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                if (doc['dosagem'] != null) Text('Dosagem: ${doc['dosagem']}'),
                                if (doc['prazoDias'] != null) Text('Prazo: ${doc['prazoDias']} dias'),
                                if (doc['observacoes'] != null && doc['observacoes'].toString().isNotEmpty)
                                  Text('Obs: ${doc['observacoes']}'),
                                if (doc['createdAt'] != null)
                                  Text('Início: ${_formatDate(doc['createdAt'])}'),
                                if (doc['createdAt'] != null && doc['prazoDias'] != null)
                                  Text('Fim: ${_formatDate(_addDays(doc['createdAt'], doc['prazoDias']))}'),
                              ],
                            ),
                            trailing: IconButton(
